...
namespace DoctrineORMModule\Proxy\__CG__\AlexDoctrine\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Customers extends \AlexDoctrine\Entity\Customers implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'calls', 'firstName', 'lastName', 'phone', 'address', 'status');
        }
    ...
    public function setCalls($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCalls', array($value));

        return parent::setCalls($value);
    }
    ...
    public function setAddress($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAddress', array($value));
